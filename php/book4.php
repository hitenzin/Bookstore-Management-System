		...
		<div id="header" class="shell">
			...
			<center><h3>Book Details</h3></center>
				<!-- End Header -->
					...
					<form>
						<fieldset >
							<legend>Strange Case of Finley Jayne</legend><br>
						    ...
						    <?php
				    	        ...
				    	        $result = mysql_query("SELECT * FROM Books 
				    	        	where Title = 'Strange Case of Finley Jayne'"); 
						
				                echo "<h4><table>"; 
					            while ($row = mysql_fetch_array($result)) {
					            		echo "<tr><td><img src=\"css/images/image04.jpg\" height=200 width=150/></td></tr>";
